...
/* ============================================================
   ⚠ **"ועדת קבוצה ותוכן" — תיבה בלוח, לא שם בקוד**
   ------------------------------------------------------------
   שלושה מסכים באחריותה: שיעורי חניך, המליאות ומאגר המרצים.
   אותו דפוס בדיוק של ועדת הגיוסים (5ד): השם בלוח עשוי
   להשתנות או להתפצל, וכל התאמת שם בקוד נשברת בשקט.

   ⚠ **והבדיקה `mayContent` יושבת בשרת ולא ב-`withAuth`** —
     דגליו הם AND, והשאלה כאן היא איחוד: צוות **או** יו״ר
     **או** חבר הוועדה. אותו נימוק כמו `mayArea` (4כב),
