...
export const PLACEMENT_COLS = {
  definitions: {
    ...
    /* ============================================================
       ⚠ **"זו ועדת קבוצה ותוכן" — תיבה בלוח, מאותו טעם בדיוק.**

       שלושה מסכים חדשים באחריותה: שיעורי חניך, המליאות, ומאגר
       המרצים. השם בלוח עשוי להשתנות, להתאחד או להתפצל, וכל
       התאמת שם בקוד הייתה נשברת בשקט — והוועדה הייתה מגלה
       שהמסכים נעלמו לה.

       ⚠ ריק עד ש-`npm run seed:stulesson` ירוץ, ואז אף ועדה
         אינה מסומנת: המסכים נשארים לצוות בלבד והמסך אומר
         מה לסמן (עיקרון 6).
       ============================================================ */
    content: "boolean_mm7185p3",
    /* ⚠ ריק עד ש-`npm run seed:community -- --go` ירוץ.
       "זמן קהילה" ו"משפחות מאמצות" באחריותה (16.9.2026),
       באותה צורה בדיוק של `content`. */
    community: "boolean_mm78gyr6",
    /* ============================================================
       ⚠ **סיכום הסדרה — נכתב על ידי כל חברי הסדרה.**
         בקשה מפורשת של המכינה. סיכום שרק היו״ר יכול לגעת בו
         אינו סיכום של הסדרה. `mayTeam(...).write` הוא הכלל.
       ============================================================ */
    summary: "long_text_mm6wpwse",
    summaryBy: "text_mm6wwkfw",
