...
export const DUTIES = {
  [ROLE_KITCHEN]: {
    ...
    tabs: [
      ...
      /* ⚠ **קניות המכינה — אותו מסך לשלושת האחראים.** שלוש
         רשימות הקניות במקום אחד, כדי שמי שיוצא לקניות לא
         יפספס שורה שיושבת ברשימה של מישהו אחר. `dutyTabs`
         מאחד לפי `tab`, ולכן חניך שנושא שני תפקידים רואה
         אותו פעם אחת (4ק). */
