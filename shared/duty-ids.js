/* ============================================================
   ...
   ------------------------------------------------------------
   ⚠ אין לערוך ידנית. הלוחות נוצרו על ידי
     `scratchpad/add-duty-boards.mjs`.

   ⚠⚠ **הקובץ הזה ו-`shared/team-ids.js` נראים דומים והם הפוכים.**
     כאן עמודת הבעלים מחזיקה **מזהה בלבד**, כדי שהלוח ייקרא
     כרשימה של תפקיד ולא כיומן של אדם (CLAUDE 4מה). שם, בלוח
     הצוותים, נכתב **גם השם** — כי משימת ועדה משותפת ו"באחריות
     מי" היא כל התכלית.

     שניהם נכונים, ומי שיראה אותם זה לצד זה עלול "לתקן" אחד
     לפי השני. ראו CLAUDE.md סעיף 4נ, ו-`scratchpad/team-test.mjs`
     שנועל את **שני** הכיוונים באותה הרצה.
