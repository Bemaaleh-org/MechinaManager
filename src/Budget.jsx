                    ...
                    <div className="st-row" key={o.id} style={{ cursor: "default" }}>
                      <div className="st-main">
                        ...
                        <div className="st-m">
                          ...
                          {/* ============================================================
                              ⚠⚠ **מי עומד מאחורי השורה** (בקשת ראש
                              המכינה, 22.9.2026: *"מעבר לסכום והתאריך
                              יהיה כתוב מי הזין את אותה קבלה"*).

                              ⚠ **שני אנשים ולא אחד**: מי שרשם את
                                הקנייה, ומי שהעלה את הקבלה. כשהם
                                אותו אדם מוצג שם אחד — שתי שורות
                                זהות נקראות כמו תקלה.
                              ⚠ ושורה בלי שם אינה מציגה מציין מקום —
                                29 הקניות שנרשמו לפני שהעמודה נולדה
                                אינן יודעות מי רשם אותן, ו"לא ידוע" על
                                כל שורה הוא רעש (עיקרון 6).
                              ============================================================ */}
                          {o.createdBy && <span>· רשם/ה {o.createdBy}</span>}
                          {o.by && o.by !== o.createdBy && (
                            <span>· קבלה {o.by}</span>
                          )}
                        </div>
