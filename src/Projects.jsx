  ...
  return (
    <>
      ...
      {/* ============================================================
          ...
          ⚠⚠ **ותוקנה ב-15.9.2026:** אחראי בינה במצב מפתח קורא
            את הפרויקטים (החלטת ראש המכינה). "הצוות אינו רואה"
            נשאר נכון במלואו; "שלך בלבד" לא — והמשפט אומר
            עכשיו את שניהם. ראו 5ח: המחיר מוצהר במסך.
          ============================================================ */}
      <div className="pr-private">
        <PI.lock />
        <div>
          <b>הפרויקטים כאן שלך.</b> הצוות אינו רואה אותם — גם לא ראש
          המכינה. מה שמשותף הוא רק מה שתשתפו עם חניכים אחרים.
          {" "}אחראי הבינה, שמפתח את האפליקציה, רואה אותם לצורך עבודתו.
        </div>
      </div>
