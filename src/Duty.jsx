    ...
    <>
      ...
      {tasks.length === 0 ? (
        <div className="attn-calm" style={{ marginBottom: 14 }}>
          ...
          <span>הרשימה הזו שלך — הצוות אינו רואה אותה</span>
        </div>
      ) : (
  ...
  return (
    <>
      ...
      {/* ============================================================
          ...
          ⚠⚠ **ומאז 15.9.2026 היא מדויקת פחות, ולכן נוסחה מחדש.**
            אחראי בינה במצב מפתח קורא את המשימות (החלטת ראש
            המכינה). "הצוות אינו רואה" נשאר נכון; "שלך בלבד"
            הפסיק להיות — והמשפט אומר עכשיו את שניהם. אפליקציה
            שממשיכה להבטיח דבר שאינו מתקיים גרועה מאפליקציה
            שאומרת את האמת, וזה הכלל של 4מה עצמו.
          ============================================================ */}
      <div className="pf-note" style={{ marginTop: 4 }}>
        המשימות כאן שלך. הצוות אינו רואה אותן ואינו יודע מה סימנת —
        הוא יכול רק להציף אליך נושא, ואתה מחליט מה לעשות איתו.
        {" "}אחראי הבינה, שמפתח את האפליקציה, רואה אותן לצורך עבודתו.
      </div>
      <div style={{ height: 40 }} />
    </>
  );
