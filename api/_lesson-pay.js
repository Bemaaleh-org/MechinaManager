...
/* ============================================================
   ...
   ============================================================ */
/* ⚠ **מיוצאת כדי שהכלל ייבדק טהור.** חשבון הבדיקה
   נושא את תפקיד אחראי הלו״ז (4ת), ולכן דרכו אי אפשר
   לבדוק שמוביל שבוע נחסם — אותו נימוק של `mayChores` (5כז). */
export function mayPay(session) {
