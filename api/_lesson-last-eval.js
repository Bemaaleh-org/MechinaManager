/* ============================================================
   ...
   ⚠⚠ **ורק כשיש טקסט.** `ensureEvalForMeeting` פותחת שורה
     **ריקה מהערה** בכל סימון "התקיים" (5לג) — עשרות כאלה.
     כרטיס שיציג שורה בלי מילה הוא רעש שמפסיקים לראות, והבקשה
     היא במפורש "החוות דעת המילולית".
