...
async function handler(req, res, session) {
  ...
  /* ⚠ הקבוצה "מה שהמערכת אינה קוראת" הוסרה לבקשת ראש המכינה
     (ספטמבר 2026). הכלל עצמו לא זז — כתובת, הורים, קופת חולים
     ובעיה רפואית עדיין אינם נשלפים בשום מסלול (4פ, 4יג); רק
     ההצהרה עליהם יצאה מהמסך. */
